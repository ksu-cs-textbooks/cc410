...
<section>
    <h3>Generalized Tests</h3>
        <pre class="python stretch" style="font-size: 40px"><code>class TestTheRiker:<br>
	PRICE: float = 17.01
...
<section>
	<h3>My Schedule</h3>
	<ul>
		<li>Feb 3: Conference</li>
		<li>Feb 17 - 22: Conference</li>
	</ul>
	<i>Slower email responses & grading</i>
</section>
<section>
