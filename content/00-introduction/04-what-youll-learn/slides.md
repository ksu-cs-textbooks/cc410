...
<section>
	<h2>Programming</h2>
	<img class="plain" style="height: 40%;" src="/images/0/java_logo_wiki.svg">
	<img class="plain stretch" src="/images/0/python_logo_wiki.svg">
...
<section>
	<h2>Why?</h2>
	<img class="plain" style="float: left; height: 60%; margin: 0px 20px" src="/images/0/hawking_wiki.jpg">
