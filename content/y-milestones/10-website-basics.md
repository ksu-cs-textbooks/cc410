...
<div>
{{% badge style="orange" %}}YELLOW: Limited GenAI Usage Allowed {{% /badge %}} For this project, you may make limited use of GenAI to answer questions and receive suggestions about how to add basic website functionality to your project. Your resulting code should closely follow the model shown in the related example project (this will make future milestones simpler). You <b>may not</b> use the results of GenAI directly in your code or documentation comments, except in the Web design portions as described below.
</div>
</div>
